...
<?php
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('EloJob', '$valor',  '$elo_inicial', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = '$elo_inicial' AND elo_final = '$elo_final' AND titulo = 'elojob'");
...
<body id="page-top">
  ...
  <header class="masthead">
     <div class="container">
          <div class="masthead-subheading">EloJob!</div>
    ...
    <section class="service-area-v3 pt-120 pb-120" aria-hidden="false" id="elojob">
            <div class="container">
                <div class="row" >
                    <div class="col-lg-12">
                        <div class="section-title text-center mb-80" >
                            <h2 style="margin-bottom: 0;">Compre Elojob</h2>
                ...
                <form action="elojob.php" method="post">
                <div class="row">
   ...
   <select id="ct" name="ct" class="form-control">
    <option value="ferro" data-img="imagenselo/ferro.png">Ferro</option>
    <option value="bronze" data-img="imagenselo/bronze.png">Bronze</option>
    <option value="prata" data-img="imagenselo/prata.png">Prata</option>
    <option value="ouro" selected="" data-img="imagenselo/ouro.png">Ouro</option>
    <option value="platina" data-img="imagenselo/platina.png">Platina</option>
    <option value="diamante" data-img="imagenselo/diamante.png">Diamante</option>
    <option value="mestre" id="m" data-img="imagenselo/mestre.png">Mestre</option>
          </select>
  </div></div>
  <div class="col-md-5"><div class="form-group">
   <select id="cd" name="cd" class="form-control">
            ...
            <option value="1" selected="">1</option>
                            ...
                            <div class="service-icon text-center mt-30">
                                <img id="eloa" src="imagenselo/ouro.png">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
   ...
   <select id="dt" name="dt" class="form-control">
            ...
            <option value="platina" data-img="imagenselo/platina.png">Platina</option>
            <option value="diamante" data-img="imagenselo/diamante.png">Diamante</option>
            <option value="mestre" id="mestre" data-img="imagenselo/mestre.png">Mestre</option>
            <option value="graomestre" id="graomestre" data-img="imagenselo/grao-mestre.png">Grão Mestre</option>
          </select>
  </div></div>
  <div class="col-md-5"><div class="form-group">
   <select id="dd" name="dd" class="form-control">
            ...
            <option value="1" selected="selected">1</option>
                            ...
                            <div class="service-icon text-center mt-30">
                                <img id="elof" src="imagenselo/ouro.png">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="service-content" style="color:#fff;">
                              <h3 class="title text-center">Dê um boost no seu pedido!</h3>
                                ...
                                <label class="form-check-label" for="defaultCheck1">
                                  Feitiço de Invocador - <strong> Gratuito</strong>
                                </label>
                                ...
                                <label class="form-check-label" for="defaultCheck1">
                                  Seleção de campeões (minimo 4 campeões para escolher) - <strong>+5 %</strong>
                                </label>
                                ...
                                <input type="hidden" name="servicoelojob" value="servicoelojob">
                                                                        ...
                                                                        <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="25" id="adicional9" name="adicional9">
                                <label class="form-check-label" for="defaultCheck1">
                                  Ganho 14 ou menos PDL por partida - <strong>+25 %</strong>
                                </label>
                                <input type="hidden" name="nomeadicional9" value="Ganho 14 ou menos PDL por partida">
                                <input type="hidden" name="servicoelojob" value="servicoelojob">
                              </div>
                                                                        <div class="form-check">
...
function EloEvolution(attrs) {
  ...
  this._sequence = [
    'ferro4', 'ferro3', 'ferro2', 'ferro1',
    'bronze4', 'bronze3', 'bronze2', 'bronze1',
    'prata4', 'prata3', 'prata2', 'prata1',
    'ouro4', 'ouro3', 'ouro2', 'ouro1',
    'platina4', 'platina3', 'platina2', 'platina1',
    'diamante4', 'diamante3', 'diamante2', 'diamante1',
    'mestre4', 'mestre3', 'mestre2', 'mestre1',
    'graomestre4', 'graomestre3', 'graomestre2', 'graomestre1',
    'c4', 'c3', 'c2', 'c1'
  ];
  this.errors = [];
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <h6> No momento só aceitamos PIX.</h6>
                        ...
                        <button type="submit" class="main-btn" style="width: 100%;" name="compra">Pagar</button></div>
                </div>
                </form>
            </div>
        </section>
