<?php
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('DuoBoost', '$valor',  '$elo_inicial', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = '$elo_inicial' AND elo_final = '$elo_final' AND titulo = 'DuoBoost'");
...
<script type="text/javascript" src="./css/jquery-migrate.min.js.download" id="jquery-migrate-js"></script>
	    ...
	    <link rel="shortcut icon" href="/assets/img/ICON_DRAGON_INVISIVEL355.ico" type="image/png">
    <!--====== Bootstrap css ======-->
...
<body data-rsssl="1" class="class=" page-template-default="" page="" page-id-369="" woocommerce-no-js="" elementor-default="" elementor-kit-8""="">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">DuoBoost!</div>
    ...
    <section class="service-area-v3 pt-120 pb-120" aria-hidden="false" id="duoboost">
            <div class="container">
                <div class="row" >
                    <div class="col-lg-12">
                        <div class="section-title text-center mb-80" >
                            <h2 style="margin-bottom: 0;">Compre DuoBoost</h2>
                            <p>Nesse serviço nós estaremos indo duo e upando até o elo desejado, zelando sempre pela segurança e privacidade.</p>
                        </div>
                    </div>
                </div>
                <form action="DuoBoost.php" method="post">
                <div class="row">
