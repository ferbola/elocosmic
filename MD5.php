<?php
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('MD5 Valorant', '$valor',  'MD5 Valorant', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'MD5 Valorant' AND elo_final = '$elo_final' AND titulo = 'MD5 Valorant'");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">MD5!</div>
        ...
        <section class="service-area-v3 pt-120 pb-120" id="md10">
          <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="section-title text-center mb-80">
                          <h2 style="margin-bottom: 0;">Compre MD5</h2>
              ...
              <form action="MD5.php" method="post" id="enviareloboost">
              <div class="row">
...
<select id="ct" name="ct" class="form-control">
  ...
  <option value="u40" data-img="imagenselo/unranked.png">Sem Ranking</option>
          <option value="ferro85" data-img="imagenselo/ferrovalorant.png">Ferro</option>
          <option value="bronze85" data-img="imagenselo/bronzevalorant.png">Bronze</option>
          <option value="prata85" data-img="imagenselo/pratavalorant.png" >Prata</option>
          <option value="ouro85" data-img="imagenselo/ourovalorant.png">Ouro</option>
          <option value="platina85" data-img="imagenselo/platinavalorant.png">Platina</option>
          <option value="diamante85" data-img="imagenselo/diamantevalorant.png">Diamante</option>
          <option value="ascendente85" data-img="imagenselo/ascendente.png">Ascendente</option>
          <option value="immortal85" data-img="imagenselo/Immortal.png">Immortal</option>
        </select>
</div></div>
                              </div>
                          </div>
                      ...
                      <div class="service-item mb-30" style="background:#87ceeb;">
                          <div class="service-content" style="color:#fff;">
                            <h3 class="title text-center"><a href="#" style="color:#fff;">Dê um boost no seu pedido!</a></h3>
                              ...
                              <label class="form-check-label" for="defaultCheck1">
                                Seleção de Agentes (minimo 4 Agentes para escolher) - <strong>+5 %</strong>
                              </label>
