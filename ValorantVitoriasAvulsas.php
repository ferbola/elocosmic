<?php
  ...
  $elo_final = $_POST['ct'];
  $Quant = $_POST['cd'];
  $nome = "Vitorias Valorant" . " Quantidade: " . $Quant;
  $valor = "0";
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('$nome', '$valor',  'Vitorias Valorant', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'Vitorias Valorant' AND elo_final = '$elo_final' AND titulo = '$nome'");
...
<html lang="pt-br" class="sizes customelements history pointerevents postmessage webgl websockets cssanimations csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside flexbox picture srcset webworkers"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!--====== Title ======-->
   <title>Vitórias Avulsas - EloSky</title>
    <!--====== Favicon Icon ======-->
            <style type="text/css">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">Vitoria Avulsa!</div>
                <div class="masthead-heading text-uppercase">Clique no botão abaixo!</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#duoboost">Saiba Mais</a>
            </div>
        </header>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="section-title text-center mb-80">
                          <h2 style="margin-bottom: 0;">Compre Vitórias Avulsas</h2>
                          <p>Está com medo de dropar, ou de falhar naquela partida que será decisiva para sua classificação? Garanta vitórias e esqueça esse medo!</p>
                      </div>
                  </div>
              </div>
              <form action="ValorantVitoriasAvulsas.php" method="post" id="enviareloboost">
              <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12">
                      <div class="service-item mb-30">
                          <div class="service-content">
                              <h3 class="title text-center"><a href="#" style="color:#111">Tier Atual</a></h3>
                              <div class="row">
                                                                                                                                                                    <div class="col-md-12"><div class="form-group">
<select id="ct" name="ct" class="form-control">
  <option value="semselecao">Selecione um tier</option>
          <option value="ferro2" data-img="imagenselo/ferrovalorant.png">Ferro</option>
          <option value="bronze5" data-img="imagenselo/bronzevalorant.png">Bronze</option>
          <option value="prata8" data-img="imagenselo/pratavalorant.png" >Prata</option>
          <option value="ouro13" data-img="imagenselo/ourovalorant.png">Ouro</option>
          <option value="platina16" data-img="imagenselo/platinavalorant.png">Platina</option>
          <option value="diamante24" data-img="imagenselo/diamantevalorant.png">Diamante</option>
          <option value="ascendente30" data-img="imagenselo/ascendente.png">Ascendente</option>
          <option value="immortal36" data-img="imagenselo/Immortal.png">Immortal</option>
          <option value="radiant60" data-img="imagenselo/radiant.png">Radiant</option>
        </select>
</div></div>
<div class="col-md-12">
<div class="offer__content text-center" style="margin-bottom: 20px; margin-top: 0;">
                                 <h3 class="title text-center"><a href="#" style="color:#111">Quantidade de Vitórias</a></h3>
                              </div>
  ...
  <select id="cd" name="cd" class="form-control">
          ...
          <option value="3">3</option>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="service-item mb-30" style="background:#87ceeb; min-height: 435px">
                          <div class="service-content" style="color:#fff;">
                            <h3 class="title text-center"><a href="#" style="color:#fff;">Dê um boost no seu pedido!</a></h3>
                                                                                                                                                                                           <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="0" id="adicional2" name="adicional2">
                              <label class="form-check-label" for="defaultCheck1">
                                Feitiço de invocador - <strong class="adicionalp"> Gratuito</strong>
                              </label>
                              <input type="hidden" name="nomeadicional2" value="Feitiço de invocador">
                            </div>
                                                                      <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="0" id="adicional3" name="adicional3">
                              <label class="form-check-label" for="defaultCheck1">
                                Chat offline - <strong class="adicionalp"> Gratuito</strong>
                              </label>
                              <input type="hidden" name="nomeadicional3" value="Chat offline">
                            </div>
                                                                      <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="5" id="adicional5" name="adicional5">
                              <label class="form-check-label" for="defaultCheck1">
                                Seleção de agentes - <strong class="adicionalp">+5 %</strong>
                              </label>
                              <input type="hidden" name="nomeadicional5" value="Seleção de campeões">
                            </div>
                                                                      <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="10" id="adicional6" name="adicional6">
                              <label class="form-check-label" for="defaultCheck1">
                                Definição de horário - <strong class="adicionalp">+10 %</strong>
                              </label>
                              <input type="hidden" name="nomeadicional6" value="Definição de horário">
                            </div>
                                                                      <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="20" id="adicional7" name="adicional7">
                              <label class="form-check-label" for="defaultCheck1">
                                Entrega super rápida - <strong class="adicionalp">+20 %</strong>
                              </label>
                              <input type="hidden" name="nomeadicional7" value="Entrega super rápida">
                            </div>
                                                                                                                        </div>
                      </div>
                      <div class="col-lg-12" style="border-bottom: 15px solid #87ceeb; padding-bottom: 10px; padding-top:0">
                                          <div class="form_group text-center">
                                             ...
                                             <a href="#" class="bton" style="color: #f9580e; font-size: 26px; font-weight: bold; width: 100%"><div id="price" valor-inicial="35">R$ 0,00</div></a>
                                          </div>
                                      </div>
...
<div class="form-group row">
  ...
  <div class="col-8">
    ...
    <h6> No momento só aceitamos PIX.</h6>
                      ...
                      <button name="compra" type="submit" class="main-btn" style="width: 100%;" id="linkativo">Pagar</button>
