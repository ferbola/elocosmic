<?php
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('$nome', '$valor',  'Manutenção de Elo', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'Manutenção de Elo' AND elo_final = '$elo_final' AND titulo = '$nome'");
...
<html lang="pt-br" class="sizes customelements history pointerevents postmessage webgl websockets cssanimations csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside flexbox picture srcset webworkers"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!--====== Title ======-->
   <title>Manutenção De Elo - EloSky</title>
    <!--====== Favicon Icon ======-->
            <style type="text/css">
...
<body data-rsssl="1" class="class=" page-template-default="" page="" page-id-369="" theme-elorapido="" woocommerce-no-js="" elementor-default="" elementor-kit-8""="">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">Manutenção De Elo!</div>
                <div class="masthead-heading text-uppercase">Clique no botão abaixo!</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#manutençãodeelo">Saiba Mais</a>
            </div>
        </header>
        <!--====== Start Features section ======-->
        <section class="service-area-v3 pt-120 pb-50" id="manutençãodeelo">
          <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="section-title text-center mb-80">
                          <h2 style="margin-bottom: 0;">Compre Manutenção de Elo</h2>
                          <p>No serviço de Manutenção de Elo para League of Legends (LoL), um de nossos melhores jogadores profissionais irá entrar em sua conta e jogar partidas ranqueadas.</p>
                      </div>
                  </div>
              </div>
              <form action="ManutençãoDeElo.php" method="post" id="enviareloboost">
              <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12">
                      <div class="service-item mb-30">
                          <div class="service-content">
                              <h3 class="title text-center"><a href="#" style="color: #000;">Seu Ranking Atual</a></h3>
                              <div class="row">
                                                                                                                                                                   <div class="col-md-12"><div class="form-group">
    <select id="ct" name="ct" class="form-control">
    <option value="semselecao">Selecione um tier</option>
    <option value="challenger 750" data-img="imagenselo/challenger.png">Challenger</option>
    <option value="grao mestre 500" data-img="imagenselo/grao-mestre.png">Grão Mestre</option>
      <option value="mestre 300" data-img="imagenselo/mestre.png">Mestre</option>
      <option value="diamante 150" data-img="imagenselo/diamante.png">Diamante</option>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="service-item mb-30" style="background:#87ceeb;">
                          <div class="service-content" style="color:#fff; min-height: 370px;">
