<?php
  ...
  $elo_final = $_POST['ct'];
  $Quant = $_POST['cd'];
  $nome = "Vitorias" . " Quantidade: " . $Quant;
  $valor = "0";
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('$nome', '$valor',  'Vitorias', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'Vitorias' AND elo_final = '$elo_final' AND titulo = '$nome'");
      ...
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="#vavulsas">Saiba Mais</a>
            </div>
        </header>
        <!--====== Start Features section ======-->
        <section class="service-area-v3 pt-120 pb-120">
          <div class="container" id="vavulsas">
              <div class="row">
                  <div class="col-lg-12">
              ...
              <form action="VitoriasAvulsas.php" method="post" id="enviareloboost">
              <div class="row">
...
<select id="ct" name="ct" class="form-control">
  <option value="semselecao">Selecione um tier</option>
          <option value="ferro4" data-img="imagenselo/ferro.png">Ferro</option>
          <option value="bronze5" data-img="imagenselo/bronze.png">Bronze</option>
          <option value="prata6" data-img="imagenselo/prata.png" >Prata</option>
          <option value="ouro7" data-img="imagenselo/ouro.png">Ouro</option>
          <option value="platina10" data-img="imagenselo/platina.png">Platina</option>
          <option value="diamante17" data-img="imagenselo/diamante.png">Diamante</option>
          <option value="mestre59" data-img="imagenselo/mestre.png">Mestre</option>
        </select>
</div></div>
<div class="col-md-12">
                      ...
                      <div class="service-item mb-30" style="background:#87ceeb; min-height: 435px">
                          <div class="service-content" style="color:#fff;">
                            <h3 class="title text-center"><a href="#" style="color:#fff;">Dê um boost no seu pedido!</a></h3>
                              ...
                              <label class="form-check-label" for="defaultCheck1">
                                Escolha as rotas - <strong class="adicionalp"> Gratuito</strong>
                              </label>
                              <input type="hidden" name="nomeadicional4" value="Escolha as rotas">
                            </div>
                                                                      <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="5" id="adicional5" name="adicional5">
                              <label class="form-check-label" for="defaultCheck1">
                                Seleção de campeões - <strong class="adicionalp">+5 %</strong>
                              </label>
