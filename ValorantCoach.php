<?php
  ...
  $elo_final = $_POST['ct'];
  $Quant = $_POST['cd'];
  $nome = "Coach Valorant" . " Quantidade: " . $Quant;
  $valor = "0";
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('$nome', '$valor',  'Coach Valorant', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'Coach Valorant' AND elo_final = '$elo_final' AND titulo = '$nome'");
...
<body id="page-top">
  ...
  <header class="masthead">
     <div class="container">
          <div class="masthead-subheading">Coach Valorant</div>
          <div class="masthead-heading text-uppercase">Clique abaixo para saber mais!</div>
          <a class="btn btn-primary btn-xl text-uppercase" href="#serviceslol">Saiba Mais</a>
      </div>
  </header>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="section-title text-center mb-80">
                          ...
                          <p>Melhore suas habilidades e estrategias em Valorant, com os nossos professores.</p>
                          <div class="title-span-line text-center">
                          </div>
                      </div>
                  </div>
              </div>
              <form action="ValorantCoach.php" method="post">
              <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12">
                      <div class="service-item mb-30">
                          ...
                          <div class="service-content">
                              <h3 class="title text-center"><a href="#" style="color: #000;">Tier Atual</a></h3>
                              <div class="row">
                                                                                                                                                                    <div class="col-md-12"><div class="form-group">
<select id="ct" name="ct" class="form-control">
  <option value="semselecao">Selecione um tier</option>
          <option value="45" data-img="">Iniciante (Ferro-Prata)</option>
          <option value="45" data-img="">Intermédiario (Ouro - Platina)</option>
          <option value="45" data-img="" >Experiente (Diamante - Ascendente)</option>
        </select>
</div></div>
<div class="col-md-12">
