<?php
  ...
  if ($login['id'] == null){
    ...
    $login_id = $login['id'];
    $servicoAdd = mysqli_query($mysqli, "INSERT INTO servico (titulo, valor , elo_inicial, elo_final) VALUES ('MD10', '$valor',  'MD10', '$elo_final')");
    ...
    $servico = mysqli_query($mysqli, "SELECT id FROM servico WHERE valor = '$valor' AND elo_inicial = 'MD10' AND elo_final = '$elo_final' AND titulo = 'MD10'");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
          ...
          <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">MD10!</div>
                <div class="masthead-heading text-uppercase">Clique no botão abaixo!</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#md10">Saiba Mais</a>
            </div>
        </header>
        <!--====== Start Features section ======-->
        <section class="service-area-v3 pt-120 pb-120" id="md10">
          <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="section-title text-center mb-80">
                          <h2 style="margin-bottom: 0;">Compre MD10</h2>
                          <p>Nós iremos te ajudar a começar as ranqueadas em uma melhor colocação, os melhores boosters serão selecionados para executar esse trabalho!</p>
                      </div>
                  </div>
              </div>
              <form action="MD10.php" method="post" id="enviareloboost">
              <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12">
                      <div class="service-item mb-30">
                          <div class="service-content">
                              <h3 class="title text-center"><a href="#" style="color: #000">Último Ranking</a></h3>
                              <div class="row">
                                                                                                                                                                   <div class="col-md-12"><div class="form-group">
<select id="ct" name="ct" class="form-control">
  <option value="semselecao">Selecione um tier</option>
  <option value="u40" data-img="imagenselo/unranked.png">Sem Ranking</option>
          <option value="ferro60" data-img="imagenselo/ferro.png">Ferro</option>
          <option value="bronze60" data-img="imagenselo/bronze.png">Bronze</option>
          <option value="prata60" data-img="imagenselo/prata.png" >Prata</option>
          <option value="ouro80" data-img="imagenselo/ouro.png">Ouro</option>
          <option value="platina90" data-img="imagenselo/platina.png">Platina</option>
          <option value="diamante100" data-img="imagenselo/diamante.png">Diamante</option>
        </select>
</div></div>
                              </div>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="service-item mb-30" style="background:#87ceeb;">
...
if ( historyTraversal ) {
  ...
  window.location.reload();
      ...
      var MultipliedValue = transvalor;
