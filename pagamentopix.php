...
<body data-rsssl="1" class="class=" page-template-default="" page="" page-id-369="" woocommerce-no-js="" elementor-default="" elementor-kit-8""="">
  ...
  <header class="masthead">
           <div class="container">
                <div class="masthead-subheading">Pagamento!</div>
        ...
        <section class="service-area-v3 pt-70 pb-20">
        
        <div class="container" id="md10">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-30">
                        <h2 style="margin-bottom: 0;">Pagamento! :)</h2>
                        <p>Estamos quase lá. Conferimos seu pedido e está tudo ok.</p>
                    </div>
                </div>

            <div class="col-lg-12 text-center">
    <h4>Obrigado por comprar conosco. Você escolheu o <strong><u>PIX como método de pagamento</u></strong> coloque o valor correto do pagamento e mande as informações sobre o pedido no whatsapp abaixo :)</h4>
                    <div class="container">
                         <h5 class="text-center">Pagamento</h5>

                Linha do Pix (copia e cola):
<textarea style="width: 100%;">
00020126790014br.gov.bcb.pix0136a7690fd6-33be-45b0-8ad4-793cb9350a940217PagamentoDoPedido52040000530398654040.005802BR5907Patrick6009SAO PAULO62100506EloSky63049C3A</textarea>

<img src="https://i.imgur.com/R7QbgAz.png"></center>                        </div>
                    <div class="col-md-1 text-left"></div>
                </div>
                <div class="row" style="margin-top: 30px; background: #87ceeb; color:#fff !important; padding: 20px;">
                    <h5 style="color:#000;">Finalizou o pagamento? Chame a gente no <a style="color:#000" href="https://api.whatsapp.com/send?phone=5511995662568&text=Realizei%20o%20pagamento%2C%20segue%20o%20comprovante%3A" target="_blank"><u>WhatsApp</u></a> e apresente o comprovante. Estamos ansiosos para começar o serviço!</h5>
                </div>
